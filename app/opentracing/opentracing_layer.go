...
func (a *OpenTracingAppLayer) AcceptFriendRequest(senderid string, receiverid string) *model.AppError {
	origCtx := a.ctx
	span, newCtx := tracing.StartSpanWithParentByContext(a.ctx, "app.AcceptFriendRequest")
	...
	defer span.Finish()
	resultVar0 := a.app.AcceptFriendRequest(senderid, receiverid)
...
func (a *OpenTracingAppLayer) CreateAliasUser(user *model.User) (*model.User, *model.AppError) {
	origCtx := a.ctx
	span, newCtx := tracing.StartSpanWithParentByContext(a.ctx, "app.CreateAliasUser")
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.CreateAliasUser(user)
...
func (a *OpenTracingAppLayer) CreatePrivateEmoji(sessionUserId string, emoji *model.Emoji, multiPartImageData *multipart.Form) (*model.Emoji, *model.AppError) {
	origCtx := a.ctx
	span, newCtx := tracing.StartSpanWithParentByContext(a.ctx, "app.CreatePrivateEmoji")
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.CreatePrivateEmoji(sessionUserId, emoji, multiPartImageData)
...
func (a *OpenTracingAppLayer) DeleteEmojiWithAccess(userid string, emoji *model.Emoji) *model.AppError {
	origCtx := a.ctx
	span, newCtx := tracing.StartSpanWithParentByContext(a.ctx, "app.DeleteEmojiWithAccess")
	...
	defer span.Finish()
	resultVar0 := a.app.DeleteEmojiWithAccess(userid, emoji)
...
func (a *OpenTracingAppLayer) DeletePrivateEmojiAccess(userid string, emojiId string) *model.AppError {
	origCtx := a.ctx
	span, newCtx := tracing.StartSpanWithParentByContext(a.ctx, "app.DeletePrivateEmojiAccess")
	...
	defer span.Finish()
	resultVar0 := a.app.DeletePrivateEmojiAccess(userid, emojiId)
...
func (a *OpenTracingAppLayer) GetAliasUserId(externalId string, platform string) (string, *model.AppError) {
	origCtx := a.ctx
	span, newCtx := tracing.StartSpanWithParentByContext(a.ctx, "app.GetAliasUserId")
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.GetAliasUserId(externalId, platform)
...
func (a *OpenTracingAppLayer) GetExtChannelIdByUsers(aliasId string, realUserId string) (string, *model.AppError) {
	origCtx := a.ctx
	span, newCtx := tracing.StartSpanWithParentByContext(a.ctx, "app.GetExtChannelIdByUsers")
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.GetExtChannelIdByUsers(aliasId, realUserId)
...
func (a *OpenTracingAppLayer) GetExtRefFromAliasUserId(aliasId string) (*model.ExtRef, *model.AppError) {
	origCtx := a.ctx
	span, newCtx := tracing.StartSpanWithParentByContext(a.ctx, "app.GetExtRefFromAliasUserId")
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.GetExtRefFromAliasUserId(aliasId)
...
func (a *OpenTracingAppLayer) GetOrCreateAliasUserId(userName string, externalId string, platform string) (string, *model.AppError) {
	origCtx := a.ctx
	span, newCtx := tracing.StartSpanWithParentByContext(a.ctx, "app.GetOrCreateAliasUserId")
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.GetOrCreateAliasUserId(userName, externalId, platform)
...
func (a *OpenTracingAppLayer) GetPrivateEmojiImage(emojiId string, userId string) ([]byte, string, *model.AppError) {
	origCtx := a.ctx
	span, newCtx := tracing.StartSpanWithParentByContext(a.ctx, "app.GetPrivateEmojiImage")
	...
	defer span.Finish()
	resultVar0, resultVar1, resultVar2 := a.app.GetPrivateEmojiImage(emojiId, userId)
...
func (a *OpenTracingAppLayer) GetPrivateEmojiList(page int, perPage int, sort string, userid string) ([]*model.Emoji, *model.AppError) {
	origCtx := a.ctx
	span, newCtx := tracing.StartSpanWithParentByContext(a.ctx, "app.GetPrivateEmojiList")
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.GetPrivateEmojiList(page, perPage, sort, userid)
...
func (a *OpenTracingAppLayer) GetPublicEmojiList(page int, perPage int, sort string) ([]*model.Emoji, *model.AppError) {
	origCtx := a.ctx
	span, newCtx := tracing.StartSpanWithParentByContext(a.ctx, "app.GetPublicEmojiList")
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.GetPublicEmojiList(page, perPage, sort)
...
func (a *OpenTracingAppLayer) RejectFriendRequest(senderid string, receiverid string) *model.AppError {
	origCtx := a.ctx
	span, newCtx := tracing.StartSpanWithParentByContext(a.ctx, "app.RejectFriendRequest")
	...
	defer span.Finish()
	resultVar0 := a.app.RejectFriendRequest(senderid, receiverid)
...
func (a *OpenTracingAppLayer) SendFriendRequest(senderid string, receiverid string) *model.AppError {
	origCtx := a.ctx
	span, newCtx := tracing.StartSpanWithParentByContext(a.ctx, "app.SendFriendRequest")
	...
	defer span.Finish()
	resultVar0 := a.app.SendFriendRequest(senderid, receiverid)
...
func (a *OpenTracingAppLayer) ShowFriendsList(receiverid string) ([]*model.FriendRequest, *model.AppError) {
	origCtx := a.ctx
	span, newCtx := tracing.StartSpanWithParentByContext(a.ctx, "app.ShowFriendsList")
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.ShowFriendsList(receiverid)
...
func (a *OpenTracingAppLayer) ShowPendingFriendRequest(receiverid string) ([]*model.FriendRequest, *model.AppError) {
	origCtx := a.ctx
	span, newCtx := tracing.StartSpanWithParentByContext(a.ctx, "app.ShowPendingFriendRequest")
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.ShowPendingFriendRequest(receiverid)
